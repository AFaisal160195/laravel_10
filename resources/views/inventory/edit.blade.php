    ...
    <div class="col-md-8">
        ...
        <form role="form" action="/inventory/update" method="POST" enctype="multipart/form-data">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label>Detail</label>
                            <input type="text" class="form-control" name="detail" value="{{$data->detail}}" placeholder="Masukkan Code">
                        </div>
                        <div class="form-group">
                            <label>Archive</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="archive_detail" value="{{$archive->detail}}" placeholder="Masukkan Code">
                        </div>
                    </div>
                    <!-- /.box-body -->
